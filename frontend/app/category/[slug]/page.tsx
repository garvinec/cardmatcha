...
const categoryData = {
  ...
  dining: {
    name: "Dining & Food",
    description: "Maximum rewards at restaurants, food delivery, and dining experiences worldwide.",
    icon: "🍽️",
    cards: [3],
  },
  gas: {
    name: "Gas & Fuel",
    description: "Save money at gas stations and fuel purchases with specialized rewards programs.",
    icon: "⛽",
    cards: [],
  },
  groceries: {
    name: "Groceries",
    description: "Earn more on supermarket and grocery shopping with enhanced reward rates.",
    icon: "🛒",
    cards: [3],
  },
  business: {
    name: "Business Cards",
    description: "Designed for business owners and entrepreneurs with expense management tools and business rewards.",
    icon: "💼",
    cards: [],
  },
  student: {
    name: "Student Cards",
    description: "Perfect for building credit as a student with lower requirements and educational resources.",
    icon: "🎓",
    cards: [],
  },
  "no-fee": {
    name: "No Annual Fee",
    description: "Great rewards without the annual cost, perfect for those who want benefits without fees.",
    icon: "🆓",
    cards: [2, 6, 5],
  },
  premium: {
  ...
  "balance-transfer": {
    ...
    description: "0% intro APR for debt consolidation and balance transfers to help manage existing credit card debt.",
    icon: "🔄",
    cards: [2],
  },
}
...
const creditCards = [
  ...
  },
  {
    ...
    benefits: ["No annual fee", "No category restrictions", "0% intro APR for 18 months"],
    category: "Cash Back",
    rating: 4.6,
  ...
  },
  {
    ...
    benefits: ["$120 dining credit annually", "$120 Uber Cash annually", "No foreign transaction fees"],
    category: "Dining",
    rating: 4.7,
  ...
  },
  {
    ...
    benefits: ["$300 annual travel credit", "Priority Pass Select lounge access", "TSA PreCheck/Global Entry credit"],
  ...
  },
  {
    ...
    rewards: ["5% cash back on rotating quarterly categories (up to $1,500)", "1% cash back on all other purchases"],
    benefits: ["No annual fee", "Cashback Match for first year", "Free FICO credit score"],
  ...
  },
  {
    ...
    benefits: ["No annual fee", "0% intro APR for 15 months", "No foreign transaction fees"],
    category: "Flat Rate",
    rating: 4.4,
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  const categoryCards = creditCards.filter((card) => category.cards.includes(card.id))
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <div className="mt-6">
              <Badge variant="secondary" className="bg-blue-100 text-blue-800 text-sm px-4 py-2">
                {categoryCards.length} {categoryCards.length === 1 ? "Card" : "Cards"} Available
              </Badge>
            </div>
          </div>
          ...
          {categoryCards.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">No Cards Available Yet</h3>
              <p className="text-gray-600 mb-8">
                We're working on adding more {category.name.toLowerCase()} cards to our database.
              </p>
              <Button asChild>
