...
interface IssuerCardsSectionProps {
  initialCards: any[];
  totalCount: number;
  cardsPerPage: number;
  issuer: IssuerInfo;
...
export function IssuerCardsSection({
  initialCards,
  totalCount,
  cardsPerPage,
  issuer,
}: IssuerCardsSectionProps) {
  ...
  }, [initialCards, totalCount, issuer.slug]);
  ...
  useEffect(() => {
    ...
    const fetchCards = async () => {
      try {
        ...
        const { data, totalCount: fetchedCount } = await getCardsByIssuer(
          issuer.issuerCode,
          {
  ...
  }, [cardsPerPage, currentPage, initialCards, issuer.issuerCode, totalCount]);
